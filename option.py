...
def parse_args():
    ...
    # models
    parser.add_argument('--arch', type=str, default='2', help='Backbone Architecture')
    ...
    parser.add_argument("--patch_size", type=int, default=260) # 256 for resnet-50, 224 for efficientnet-b0, 380 b4,300 b3, 260 b2, 240 b1
